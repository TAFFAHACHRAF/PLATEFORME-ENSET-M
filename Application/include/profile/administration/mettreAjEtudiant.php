<br>
       ...
       <?php
             if( isset($_GET['mettreAjour'])) {
                 $id = $_GET['mettreAjour'];
                 $sql = "SELECT * FROM etudiant e INNER JOIN compte c ON e.ID_COMPTE=c.ID_COMPTE WHERE ID_ETUDIANT='$id'";
                 $rep = $conex->query($sql);
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div class="row">
                                                <form method="POST" action="index.php?mettreAjour=<?= $data['ID_ETUDIANT'] ?>">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label>Age : </label> 
                                                            <input name="age" type="number" class="form-control" value="<?= intval($data['DATE_NAISSANCE'])?>" >
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                    <div class="payment-adress mg-t-15">
                                                        <input type="submit" name="update_etudiant" id="basicInfoPosition" class="btn mg-b-15" value="Mettre à jour" style="color:white;background-color:#B73448">
                                                </form> 
                                                <?php
