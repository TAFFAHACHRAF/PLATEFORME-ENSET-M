<?php
    ...
    session_start();
        if(isset($_SESSION['login']) and isset($_SESSION['idEt'])){
?> 
<!doctype html>
<html >
                            ...
                            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                                <nav class="sidebar-nav left-sidebar-menu-pro">
                                    <ul class="metismenu" id="menu1">
                                        ...
                                        <li>
                                            <a class="has-arrow" href="index.php?notes=<?= $data['ID_ETUDIANT'] ?>">
                                            <i class='fa fa-pencil' style='font-size:18px;color:#333'></i>
                                                    <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Mes notes</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="has-arrow" href="index.php?absence=<?= $data['ID_ETUDIANT'] ?>">
                                            <i class='fa fa-pen-square' style='font-size:18px;color:#333'></i>
                                                    <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Mes Absences</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="has-arrow" href="index.php?biblio=1">
                                            <i class='fas fa-book text-success' style='font-size:18px;color:#333'></i>
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu-angle" aria-expanded="false">
                                                <li><a title="My Account" href="index.php?account_et=<?= $data['ID_ETUDIANT'] ?>"<span class="mini-sub-pro">Modifier le Profil </span></a></li>
                                                <li><a title="Edit Password" href="index.php?update_pass=<?= $data['ID_ETUDIANT'] ?>"<span class="mini-sub-pro">Modifier le mot de passe</span></a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a  href="../../../index.php?etout=2" aria-expanded="false"><i class='fa fa-sign-out' style='font-size:18px;color: rgb(138, 10, 10)'></i> <span class="mini-click-non">&nbsp;&nbsp;&nbsp; Se déconnecter</span></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="all-content-wrapper">
                        ...
                        <div class="header-advance-area" >
                                                                ...
                                                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="educate-icon educate-bell" aria-hidden="true"></i><span class="indicator-nt"></span></a>
                                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            from annonce a,filiere f,etudiant e,employee em
                                                                            WHERE a.audition =(select f.FILIERE_LIBELLE from filiere f where  f.ID_FILIERE={$data['ID_FILIERE']})
                                                                 ...
                                                                 <li class="nav-item">
                                                                    ...
                                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                                        <li><a href="index.php?account_et=<?= $data['ID_ETUDIANT'] ?>"><span class="edu-icon edu-home-admin author-log-ic"></span>Mon compte</a>
                                                                        </li>
                                                                        </li>
                           ...
                           <?php 
                                ...
                                if(empty($_GET['detail_an']) && empty($_GET['account_et']) && empty($_GET['update_pass']) && empty($_GET['notes']) && empty($_GET['absence']) && empty($_GET['biblio'])){
                                    $res=$conex->query($r1); 
                                    if($res){
                                        while($d=$res->fetch_assoc()){
                            ?>
