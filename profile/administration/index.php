...
<head>
    ...
    <!-- favicon
        ...
        ?>
                                ...
                                <nav class="sidebar-nav left-sidebar-menu-pro">
                                    <ul class="metismenu" id="menu1">
                                        <li>
                                            ...
                                            <i class='fa fa-home' style='font-size:18px;color:rgb(0, 0, 0)'></i>
                                                    <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Éducation</span>
                                            </a>
                                        </li>

                                        <li>
                                            <a class="has-arrow" href="all-director.php" aria-expanded="false"><i  class='fa fa-cog' style='font-size:18px;color: black'></i> <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Professeurs</span></a>
                                            <ul class="submenu-angle" aria-expanded="false">
                                                <li><a title="My Account" href="index.php?profs=true"<span class="mini-sub-pro">Professeurs </span></a></li>
                                                <li><a title="Edit Password" href="index.php?ajoutProf=true"<span class="mini-sub-pro">Ajouter un Prof</span></a></li>
                                            </ul>
                                        </li>

                                        <li>
                                            <a class="has-arrow" href="all-director.php" aria-expanded="false"><i  class='fa fa-user-graduate' style='font-size:18px;color: black'></i> <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Etudiants</span></a>
                                            <ul class="submenu-angle" aria-expanded="false">
                                                <li><a title="My Account" href="index.php?etudiants=true"<span class="mini-sub-pro">Etudiants </span></a></li>
                                                <li><a title="Edit Password" href="index.php?ajoutEtud=true"<span class="mini-sub-pro">Ajouter étudiant</span></a></li>
                                            </ul>
                                        </li>

                                        <li>
                                            <a class="has-arrow" href="all-director.php" aria-expanded="false"><i  class='fas fa-scroll' style="font-size:18px;color:rgb(0, 0, 0)"></i> <span class="mini-click-non">&nbsp;&nbsp;&nbsp;Annonces</span></a>
                                            <ul class="submenu-angle" aria-expanded="false">
                                                <li><a title="My Account" href="index.php?ajouter_annonce=1"<span class="mini-sub-pro">Ajouter Un annonce </span></a></li>
                                                <li><a title="Edit Password" href="index.php?gestion_ann=true"<span class="mini-sub-pro">gestion annonce</span></a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            <a  href="../../../index.php?etout=2" aria-expanded="false"><i class='fa fa-sign-out' style='font-size:18px;color: rgb(0, 0, 0)'></i> <span class="mini-click-non">&nbsp;&nbsp;&nbsp; Se déconnecter</span></a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="all-content-wrapper">
                        ...
                        <div class="header-advance-area" >
                                                            ...
                                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                                <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="educate-icon educate-bell" aria-hidden="true"></i><span class="indicator-nt"></span></a>
                                                                    <div role="menu" class="notification-author dropdown-menu animated zoomIn">
                                                                        ...
                                                                        <?php
                                                                            $r1="select a.ID_ANNONCE,a.TITRE,a.DESCRIPTION,a.DATE_PUB,a.IMAGE_ANNONCE,a.DOCUMENTS,em.NOM,em.PRENOM from annonce a,employee em WHERE a.ID_EMPLOYEE=em.ID_EMPLOYEE order by a.DATE_PUB DESC LIMIT 3";
                           ...
                           <?php 
                                ...
                                if(empty($_GET['detail_an']) && empty($_GET['account_et']) && empty($_GET['update_pass']) && empty($_GET['etudiants']) && empty($_GET['mettreAjour']) && empty($_GET['profs']) && empty($_GET['mettreAjourProf']) && empty($_GET['ajoutProf']) && empty($_GET['ajoutEtud']) && empty($_GET['gestion_ann']) && empty($_GET['upadate_ann']) && empty($_GET['ajouter_annonce'])){ ?>
                                    <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" >
                        <div class="analytics-sparkle-line reso-mg-b-30" id="rad">
                            <div class="analytics-content" >
                                <span class="tuition-fees"><i class='fa fa-graduation-cap' style='font-size:40px;color:rgb(38, 188, 247)'></i></span>
                                <span style="color: gray;padding-bottom:7px ;display: block;" >Totale des étudiants</span>
                                <?php
                                $cnt="select sum(f.a) ff from (select count(ID_ETUDIANT) a from etudiant ) f group by f.a ";
                                $rescnt=$conex->query($cnt);
                                $dcnt=$rescnt->fetch_assoc();
                                $tol=$dcnt['ff']*100/120;
                                ?>
                                <span style="font-weight: bolder;padding-bottom:7px ;display: block;"class="counter"><strong><?=$dcnt['ff']?></strong></span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:<?=$tol?>%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30" id="rad">
                            <div class="analytics-content" >
                                <span class="tuition-fees"><i  class='fa fa-briefcase' style='font-size:40px;color:rgb(247, 224, 18)'></i></span>
                                <span style="color: gray;padding-bottom:7px ;display: block;" >Totale des professeurs</span>
                                <?php
                                $cnt="select sum(f.a) ff from (select count(ID_EMPLOYEE) a from employee where fonction='professeur' ) f group by f.a";
                                $rescnt=$conex->query($cnt);
                                $dcnt=$rescnt->fetch_assoc();
                                $tol=$dcnt['ff']*100/50;
                                
                                ?>
                                <span style="font-weight: bol: 1.1111111111111111e+35d .;
                                
                                l!er;padding-bottom:7px ;display: block;"class="counter"><strong><?=$dcnt['ff']?></strong></span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:<?=$tol?>%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30" id="rad">
                            <div class="analytics-content">
                                <span class="tuition-fees"><i  class='fa fa-bullhorn' style='font-size:40px;color:rgba(38, 221, 21, 0.945)'></i></span>
                                <span style="color: gray;padding-bottom:7px ;display: block;" >Totale des annonces</span>
                                <?php
                                $cnt="select sum(f.a) ff from (select count(ID_ANNONCE) a from annonce ) f group by f.a";
                                $rescnt=$conex->query($cnt);
                                $dcnt=$rescnt->fetch_assoc();
                                $tol=$dcnt['ff']*100/10000000;
                                ?>
                                <span style="font-weight: bolder;padding-bottom:7px ;display: block;"class="counter"><strong><?=$dcnt['ff']?></strong></span>
                                <div class="progress m-b-0">
                                    <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:<?=$tol?>%;"> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                elseif(isset($_GET['profs'])) {
                    require("profs.php");
                }elseif(isset($_GET['etudiants'])) {
                    require("etudiants.php");
                }elseif(isset($_GET['mettreAjour'])) {
                    require('mettreAjEtudiant.php');
                }
                elseif(isset($_GET['mettreAjourProf'])) {
                    require('mettreAjourProf.php');
                }
                elseif(isset($_GET['ajoutProf'])) {
                    require('ajouterProf.php');
                }
                elseif(isset($_GET['ajoutEtud'])) {
                    require('ajoutEtudiant.php');
                }
                elseif(isset($_GET['gestion_ann'])) {
           ...
           <?php        
                ...
                <br><br><br><br>
                <div class="footer-copyright-area" style="background: none;">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
